...
{
    Task<bool> ProductExistsAsync(object productId);
    ...
    Task<bool> WarehouseExistsAsync(object warehouseId);
}
...
public class WarehouseRepository : IWarehouseRepository
{
    ...
    public Task<bool> ProductExistsAsync(object productId)
    {
    ...
    public Task<bool> WarehouseExistsAsync(object warehouseId)
    {
        throw new NotImplementedException();
    }
}